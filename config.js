...
//    configLocation: './config.json', // see ./modules/HttpConfigFetch.js
    hosts: {
        domain: 'jitsi-dev.igalia.com',
        //anonymousdomain: 'guest.example.com',
        //authdomain: 'jitsi-meet.example.com',  // defaults to <domain>
        muc: 'conference.jitsi-dev.igalia.com', // FIXME: use XEP-0030
        //jirecon: 'jirecon.jitsi-meet.example.com',
        //call_control: 'callcontrol.jitsi-meet.example.com',
        bridge: 'jitsi-videobridge.jitsi-dev.igalia.com',
        focus: 'focus.jitsi-dev.igalia.com',
    },
//  getroomnode: function (path) { return 'someprefixpossiblybasedonpath'; },
//  useStunTurn: true, // use XEP-0215 to fetch STUN and TURN server
//  useIPv6: true, // ipv6 support. use at your own risk
    useNicks: false,
    bosh: '//jitsi-dev.igalia.com/http-bind', // FIXME: use xep-0156 for that
    clientNode: 'https://jitsi-dev.igalia.com', // The name of client node advertised in XEP-0115 'c' stanza
